...
The \ccode{x-update} function given above is exemplary of the approach provided by \lsr, which allows for the switching of a local to a distributed function through the higher-order \ccode{dist} function, as demonstrated in \cref{tab:x-update}:

\tab{x-update}{Comparison of the \ccode{x-update} functions}
