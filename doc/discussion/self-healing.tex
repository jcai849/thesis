As described in Section \ref{sec:dag}, a lineage for each chunk is stored alongside it.
...
While the checkpointing has not been implemented, the pruning has been implemented in a more brute-force manner (given in Section \ref{sec:gc}) than described in this section.
