...
This involved the creation of a package that was mostly written in \proglang{C}, to create Promise types, as given in \ref{lst:promise-struct}, and perform their evaluation.
