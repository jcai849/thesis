...
function implementation (alongside special functions).
...
Beyond higher-order functions and \pkg{dplyr} or \pkg{data.table} analogues for data manipulation, the direct modelling function of \code{dfglm} is implemented to allow for fitting glms to the data.
