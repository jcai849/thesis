\subsection{\pkg{DistributedR}}\label{subsec:distributedr}
...
\subsection{\pkg{foreach} and \pkg{doX}}\label{subsec:foreach-doc}
...
\subsection{Parallel, snow, and multicore}\label{subsec:parall-snow-mult}
...
\subsection{\pkg{pbdR}}\label{subsec:pbdr}
...
\subsection{\pkg{RHadoop}}\label{subsec:rhadoop}
...
\subsection{\pkg{RHIPE} and \pkg{DeltaRho}}\label{subsec:rhipe-deltarho}
...
\subsection{\pkg{hmr}}\label{subsec:hmr}
