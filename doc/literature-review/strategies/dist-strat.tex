...
More serious efforts to connect multiple commodity computers into a larger computational system is now standard, with software such as \pkg{Hadoop} and \pkg{Spark} being commonplace in large companies for the purpose of creating distributed systems.
