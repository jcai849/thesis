...
\begin{description}
    ...
    \item[biganalytics]
        ...
        \mintinline{r}{colmeans}, \mintinline{r}{apply}, as well as integration with the \pkg{biglm}
...
The package description outlines \pkg{disk.frame} with the following:
...
\begin{displayquote}
    ...
    paradigms like \pkg{dplyr} verbs and \pkg{data.table} syntax.
\end{displayquote}
