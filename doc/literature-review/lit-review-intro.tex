...
\Cref{sec:surey-r-local-packages,sec:survey-r-dist-packages,sec:survey-r-deriv,sec:survey-r-stat-model-packages} serve to narrow the scope to packages in \R{} for large data, assessing them from various angles.
