...
Such a capacity is already inherent in R, with \code{delayed-assign} from the base package granting direct access to promise creation.
...
A drawback of the approach is evaluation of parameters prior to function application, but this may be sidestepped through the \proglang{C} API in a similar manner to the definition of \code{dots-length}\cite{abelson1996sicp:order}.
