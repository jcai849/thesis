...
The last step to composition of \pkg{foreach} as capable of list comprehension is the filtering function \mintinline{R}{%when%}, which filters iterables based on some predicate to control evaluation.
