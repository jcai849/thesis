...
again, we have some chunk referenced through \mintinline{r}{d1} in \cref{lst:chunk-d1}:
...
\mintinline{r}{chunk.call} in \cref{lst:chunk-call}
...
\mintinline{r}{pmax}, using \mintinline{r}{chunk.call}, with the \cref{lst:call-along-chunks}
...
first vector \mintinline{r}{d\_1} may look something like the \cref{lst:distobj}:
...
\mintinline{r}{d\_3} like \cref{lst:distobj-call}:
...
Figure \cref{fig:chunk-recycle} shows precisely this example. Here, \mintinline{r}{x} is a
