...
Take the earlier example of maximisation in listing \cref{lst:chunk-collection}, with new object \mintinline{r}{d3}
...
In \cref{lst:chunk-apply}, over each chunk, send the \mintinline{r}{max} function, to be performed
...
\mintinline{r}{lmaxes}, as in \cref{lst:chunk-summarised}
...
as normal, locally, in \cref{lst:total-max}. This resulting value, assigned as \mintinline{r}{lmax}, is
