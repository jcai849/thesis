...
It will be discussed in greater detail in the following chapter, though an example of how some interaction may be stated syntactically is given in listing \cref{lst:write-chunk}, the act of finding the maximum value is shown at a high level, with implicit write operations, and an explicit read operation using \code{emerge}.
