...
The implementation of the distributed linear model is succinct enough to be given in it's entirety (with error-checking and boilerplate removed for clarity) in \cref{lst:dlm} .
