...
Following from the implementation of the GLM given in \cref{ch:glm}, a description is provided here of another model, using a decidedly different and straightforward process.
