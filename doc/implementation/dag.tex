...
\widefig{gc}{Chunk lineage as stored with individual chunks. Once chunk has proven existence, the lineage may be cleared and garbage collected.}

When the chunks have been proven computed, as through an \ccode{emerge}, the graph may be cleared.
...
This means that iteration is perfectly acceptable, as long as there are sufficiently regular \ccode{emerge}'s, as the older chunks are cleared away.
