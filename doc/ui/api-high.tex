...
For example, in the case of a \ccode{plus} operation over a list of values drawn from \tbb, it is equivalent to a cumulative sum.
...
The functional programming paradigm in turn makes heavy use of \ccode{Reduce} for the succinct encapsulation of the concept.
...
Unpacking this statement, \lsr provides a generic \ccode{combine} function, which is called internally by \code{emerge}.
